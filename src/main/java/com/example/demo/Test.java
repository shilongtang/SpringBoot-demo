...
public class Test {
     ...
     * 生成柱状图
     */
    public static void makeBarChart2() {
        double[][] data = new double[][] { { 672, 766, 223, 540, 126 } };
        String[] rowKeys = { "苹果" };
        String[] columnKeys = { "北京", "上海", "广州", "成都", "深圳" };
        CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
    ...
    public static void makePieChart() {
        double[] data = { 100, 200,  300,  400,  500,  600,  700};
        String[] keys = { "公众号会话", "好友转发", "朋友圈", "历史消息", "看一看", "搜一搜", "其他" };
     ...
     * @return
     */
    public static String createStackedBarChart(CategoryDataset dataset, String xName,
                                        String yName, String chartTitle, String charName) {
